...
$(document).ready(function(){
	...
	$('.chat-message button').click(function(){
		...
		if(input.val() != ''){
			add_message('You','/resources/images/demo/av1.jpg',input.val(),true);
		}		
	});
	...
	$('.chat-message input').keypress(function(e){
		if(e.which == 13) {	
			if($(this).val() != ''){
				add_message('You','/resources/images/demo/av1.jpg',$(this).val(),true);
			}		
		}
	});
	
	setTimeout(function(){
			add_message('Linda','/resources/images/demo/av2.jpg','Hello Every one do u want to freindship with me?')
		},'1000');
	setTimeout(function(){
			add_message('Mark','/resources/images/demo/av3.jpg','Yuppi! why not sirji!!.')
		},'4000');
	setTimeout(function(){
			add_message('Linda','/resources/images/demo/av2.jpg','Thanks!!! See you soon than')
		},'8000');
	setTimeout(function(){
			add_message('Mark','/resources/images/demo/av3.jpg','ok Bye than!!!.')
		},'12000');	
	setTimeout(function(){
