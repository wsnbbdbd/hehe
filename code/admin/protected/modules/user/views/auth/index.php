...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" method="post" class="form-vertical" action="/user/auth/login">
				 <div class="control-group normal_text"> <h3><img src="/resources/images/logo.png" alt="Logo" /></h3></div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" href="##" id="action_login" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
        ...
        <script src="/resources/scripts/matrix.login.js"></script> 
    </body>
